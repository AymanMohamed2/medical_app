...
class LoginWithFacebook extends LoginStrategy {
  LoginWithFacebook(super.baseAuthRemoteDataSoucrce);

  @override
  Future<UserModel> login(LoginRequestModel loginRequestModel) async {
    return baseAuthRemoteDataSoucrce.loginWithFacebook(loginRequestModel);
  }
}
