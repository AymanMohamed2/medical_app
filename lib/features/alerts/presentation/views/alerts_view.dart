...
import 'package:medical_app/features/alerts/presentation/views/widgets/alerts_view_body.dart';
    ...
    return BlocProvider(
      create: (context) =>
          FetchConsaltantsCubit(getIt.get<ConsaltantDoctorRepository>())
            ..fetchPatientConsaltants(FetchPatientConsaltantsRequestModel(
                patientEmail: GetUserData.user!.email!)),
      child: SafeArea(
          child: Scaffold(
        body: AlertsViewBody(),
      )),
