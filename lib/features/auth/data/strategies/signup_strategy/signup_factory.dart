...
import 'package:medical_app/features/auth/data/strategies/signup_strategy/email_signup.dart';
import 'package:medical_app/features/auth/data/strategies/signup_strategy/facebook_signup.dart';
import 'package:medical_app/features/auth/data/strategies/signup_strategy/google_signup.dart';
...
class SignupFactory {
  static SignupStrategy create(SignupRequestModel signupRequestModel,
    ...
    switch (signupRequestModel.signupMethod) {
      case SignupMethodEnum.email:
        return EmailSignup(authService);
      case SignupMethodEnum.facebook:
